...
{/// <summary>
/// Les propriétés de ce User concerne l'Administrateur de l'application avec la possibilité de créer des évènements,
/// des offres et d'accéder aux statistiques
/// </summary>
